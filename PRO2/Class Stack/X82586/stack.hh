/* Implementar mètode de la classe Stack per a intercanviar els dos elements del top
...
public:
  ...
  void swap2Topmost() {
    Item* ptraux = ptopitem;
    ptopitem = ptraux->next;
    ptraux->next = ptopitem->next;
    ptopitem->next = ptraux;
  }
